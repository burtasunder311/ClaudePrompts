...
```json
{"taskId": "1", "status": "in_progress"}     // Mark in progress when starting
{"taskId": "1", "status": "completed"}      // Mark completed after finishing
{"taskId": "1", "status": "deleted"}         // Delete a task
{"taskId": "1", "owner": "my-name"}          // Claim a task
{"taskId": "2", "addBlockedBy": ["1"]}       // Set up task dependencies
```
